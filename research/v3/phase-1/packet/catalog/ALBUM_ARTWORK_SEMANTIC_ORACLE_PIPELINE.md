<!-- Phase 1 author packet — provenance
     source: research/v3/ALBUM_ARTWORK_SEMANTIC_ORACLE_PIPELINE.md
...
# `ALBUM_ARTWORK_SEMANTIC_ORACLE_PIPELINE.md` — withheld from this packet

The document exists. It is at `research/v3/ALBUM_ARTWORK_SEMANTIC_ORACLE_PIPELINE.md` in the repository, and it is not in your packet.
...
Nothing from the document has been summarised or paraphrased here; this page is a closed door,
not a digest.
