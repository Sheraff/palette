...
# `ORACLE_QUESTION_SET.md` — withheld from this packet

The document exists. It is at `research/v3/ORACLE_QUESTION_SET.md` in the repository, and it is not in your packet.
