<!-- Phase 1 author packet — provenance
     ...
     §3.1 of the extract beside this file names `src/contract/PERCEPTION_VERDICT.md` as its
     "Canonical text" for open question 3. It is placed at that same relative path here so the
     pointer resolves inside this packet.
-->
