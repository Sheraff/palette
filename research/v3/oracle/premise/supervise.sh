#!/usr/bin/env bash
# Supervisor for the premise-test worker (pipeline doc §5.1).
#
#   ./supervise.sh --out ../../data/oracle-premise/premise-run-1.jsonl [worker args...]
#
...
MAX_RESTARTS=20
# [MEASURED] Model load is ~30 s; a restart storm is only detectable if the loop does not spin.
