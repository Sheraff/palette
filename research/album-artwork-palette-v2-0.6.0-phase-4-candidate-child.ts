...
type Phase4Protocol = Readonly<{
	...
	execution: Readonly<{ candidateWorkers: number; reuse: false; overwrite: false; resume: false; automaticRetry: false }>
}>
...
async function main(): Promise<void> {
	...
	if (ALBUM_ARTWORK_PALETTE_V2_VERSION !== EXPECTED_CANDIDATE_VERSION) {
		throw new Error("Candidate runtime is not the frozen 0.6.0 version")
	}
