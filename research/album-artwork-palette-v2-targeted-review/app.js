...
function renderOption(option, entry) {
	...
	for (const role of ROLE_NAMES) {
		...
		roleEntry.append(create("dd", { text: `${descriptor.nearestName} · ${treatment[role].hex}` }))
...
function persistControls() {
	...
	entry.validOptionIds = [...elements.options.querySelectorAll("input[type=checkbox]:checked")].map(({ value }) => value)
