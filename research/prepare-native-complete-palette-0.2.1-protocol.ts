...
const predecessorPath = "research/data/experiments/native-complete-palette-0.2.0-development/protocol.json"
const predecessorSha256 = "76786cae252d99c9a696cdbc641710db85f40993997842d20c055ec93aca407a"
const outputRoot = resolve(projectRoot,
	"research/data/experiments/native-complete-palette-0.2.1-development")

const closureExtras = [
	"package.json",
	"pnpm-lock.yaml",
	"research/NATIVE_COMPLETE_PALETTE_EXECUTION_PLAN.md",
	"research/NATIVE_COMPLETE_PALETTE_PROTOCOL_0_2.md",
	"research/NATIVE_COMPLETE_PALETTE_PROTOCOL_0_2_1.md",
	"research/NEXT_PALETTE_SOFT_CONTRAST_PLAN.md",
	"research/data/experiments/native-complete-palette-0.2.0-development/phase-5-failed/failure.json",
	"research/data/experiments/native-complete-palette-0.2.0-development/protocol.json",
	"research/data/experiments/native-complete-palette-0.2.0-development/rejection.json",
	"research/prepare-native-complete-palette-0.2.1-protocol.ts",
...
async function main(): Promise<void> {
	...
	if (sha256(predecessorSource) !== predecessorSha256) throw new Error("The 0.2 protocol identity changed")
	...
	protocol.predecessor = {
		...
		failureSha256: "828f3aa35d05ea24816d32b8226280dfaa99e2bb6382385360fb38b031b19bab",
		rejectionSha256: "d50dcff05759daa140831605b70c4d9a939f083d916f639f898e01e0e1ae1b69",
	}
	protocol.successorChange = {
		kind: "implementation-correction",
		scientificPolicyChanged: false,
		name: "scope-challenger-field-semantics-to-challenger-selected-route",
	}
	protocol.phase5AuthorizationAmendment.policySha256MustRemain = NATIVE_COMPLETE_PALETTE_POLICY_SHA256
	protocol.phase5Execution.version = "native-complete-palette-phase-5-execution-v2.1"
	protocol.phase5Execution.artifacts.staging =
		"research/data/experiments/native-complete-palette-0.2.1-development/.phase-5.staging"
	protocol.phase5Execution.artifacts.final =
		"research/data/experiments/native-complete-palette-0.2.1-development/phase-5"
	protocol.phase5Execution.artifacts.failure =
		"research/data/experiments/native-complete-palette-0.2.1-development/phase-5-failed"
