...
Version 0.13 is the accepted four-color algorithm. It retains 0.11's evidence-gated chromatic foreground preference and all foreground-to-surface contrast requirements, then adds the three narrow evidence rules documented above. Blinded review preferred 0.13 for each of its three changed spatial palettes; two were shippable only under 0.13 and one was shippable under both versions. Version 0.12's stricter gradient coherence experiment was rejected by human review.
