import { completeTreatmentKey, fieldDirectionKey } from "./album-artwork-palette-v2.ts";

import type { CompletePaletteTreatment, FieldHypothesis, GradientDirection, GradientTopology, NativePaletteEvidence } from "./album-artwork-palette-v2.ts";

import type { AlbumArtworkPaletteV2Phase3FieldHypothesisSourceType, AlbumArtworkPaletteV2Phase3LogicalDescriptor } from "./album-artwork-palette-v2-phase-3-common-base.ts";

import type { AlbumArtworkPaletteV2Phase3RecoverySelectorV2Evaluation, AlbumArtworkPaletteV2Phase3RecoverySelectorV2Selection } from "./album-artwork-palette-v2-phase-3-recovery-selector-v2.ts";

import { buildRoleSpecificIdentityObligations, classifyFieldConditionalFamilyRole, roleSpecificObligationCoverage } from "./album-artwork-palette-v2-phase-3-role-aware.ts";

import type { FieldConditionalRoleEvidence, RoleSpecificIdentityObligation, RoleSpecificObligationCoverage } from "./album-artwork-palette-v2-phase-3-role-aware.ts";
