import type { BackgroundFieldDomainEvidence, FieldHypothesis, GradientDirection, GradientTopology } from "./album-artwork-palette-v2.ts";

import type { FieldTransitionTrace, NativeFieldTransitionDiscovery } from "./album-artwork-palette-v2-phase-3-field-transition.ts";
