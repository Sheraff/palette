...
import type { AlbumArtworkPaletteV2Phase3FieldHypothesisSourceType } from "./album-artwork-palette-v2-phase-3-common-base.ts";

import { selectAlbumArtworkPaletteV2Phase3RecoveryV3Custody } from "./album-artwork-palette-v2-phase-3-recovery-custody-v3.ts";
...
import type { RoleSpecificIdentityObligation, RoleSpecificObligationCoverage } from "./album-artwork-palette-v2-phase-3-role-aware.ts";
