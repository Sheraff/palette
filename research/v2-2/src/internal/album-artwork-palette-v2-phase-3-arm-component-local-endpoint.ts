import type { ColorFamilyEvidence, GradientDirection, GradientFitDiagnostic, GradientTopology, NativePaletteEvidence } from "./album-artwork-palette-v2.ts";

import { ALBUM_ARTWORK_PALETTE_V2_PHASE_3_ENDPOINT_REFINEMENT_POLICY, detectDistinctBandLocalEndpointModes, materializeComponentLocalEndpointFamily, runBandLocalEndpointRepresentationMechanism } from "./album-artwork-palette-v2-phase-3-endpoint-refinement.ts";

import type { BandLocalEndpointDetectedMode, BandLocalEndpointPixelSample, BandLocalEndpointRepresentationMechanism, BandLocalEndpointRepresentationMechanismEligibility, BandLocalEndpointRepresentationMechanismFit, BandLocalEndpointRepresentationMechanismInput } from "./album-artwork-palette-v2-phase-3-endpoint-refinement.ts";
