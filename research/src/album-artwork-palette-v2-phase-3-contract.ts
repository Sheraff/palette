...
} from "./album-artwork-palette-v2-phase-3-source-light-foreground-reserve-attempt.ts"
export {
...
export type {
	AlbumArtworkPaletteV2Phase3MidpointAwareRenderCandidateApplicationInput,
...
export {
	...
	applyAlbumArtworkPaletteV2Phase3FinalCandidate,
...
export type {
	AlbumArtworkPaletteV2Phase3FinalCandidateComposition,
	AlbumArtworkPaletteV2Phase3FinalCandidateCompositionDiagnostics,
	AlbumArtworkPaletteV2Phase3FinalCandidateCompositionInput,
	AlbumArtworkPaletteV2Phase3FinalCandidateDiagnostics,
	AlbumArtworkPaletteV2Phase3FinalCandidateMechanismDiagnostics,
	AlbumArtworkPaletteV2Phase3FinalCandidateProposal,
	AlbumArtworkPaletteV2Phase3FinalCandidateProposalDiagnostic,
	AlbumArtworkPaletteV2Phase3FinalCandidateRejectionReason,
