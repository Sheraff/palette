...
export function buildAlbumArtworkPaletteV2Phase3ArmSupportedGradientPath(
	image: RawImage,
): AlbumArtworkPaletteV2Phase3ArmSupportedGradientPathResult {
	return evaluateAlbumArtworkPaletteV2Phase3ArmSupportedGradientPath(buildNativePaletteEvidence(image))
}
